...
public class ProcController {
	...
	public String os() {
		/* System.getProperty - pega a propriedade do sistema operacional */
	...
	public void chamaProcesso(String caminhoProcesso) {
		try {
			...
			// System.err.println("Arquivo inexistente, seu bosta!");
			// e.printStackTrace();
	...
	public void lerProcesso(String caminhoProcesso){
		try {
