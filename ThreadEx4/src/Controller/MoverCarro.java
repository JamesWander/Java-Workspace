...
public class MoverCarro extends Thread implements Runnable{
	...
	public MoverCarro(JLabel carro, int nCarro,JTextField Ganhador, JTextField Perdedor,JButton reiniciar)
	{
		this.lblCarro 	= carro;
		this.nCarro 	= nCarro;
	...
	{
		ImageIcon carro = new ImageIcon(tela.class.getResource("/imagens/carro "+nCarro+".png"));
